...
bool MoleculeRepository::add(DefinitionObject&& definition)
{
	...
	const auto name = definition.pullDefaultProperty(Def::Molecules::Name, "?");
	const auto hp = definition.pullDefaultProperty(Def::Molecules::Hydrophilicity, 1.0,
		Def::parse<float_n>);
	const auto lp = definition.pullDefaultProperty(Def::Molecules::Lipophilicity, 0.0,
		Def::parse<float_n>);
	const auto col = definition.pullDefaultProperty(Def::Molecules::Color, Color(0, 255, 255, 100),
		Def::parse<Color>);
