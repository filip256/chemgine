    ...
    UnitTestGroup(std::move(name), filter)
{
    ...
    registerTest<DataEstimator2DUnitTest>("linear_steep_2D", [](const float_s x) -> float_s {
        return 7.5f * x - 7.2f;
    }, EstimationMode::LINEAR, 0.0f, 1'000, -100.0f, 100.0f, 1e-05);
    registerTest<DataEstimator2DUnitTest>("linear_negative_2D", [](const float_s x) -> float_s {
        return -0.99f * x + 1.02f;
    }, EstimationMode::LINEAR, 0.0f, 1'000, -100.0f, 100.0f, 1e-05);
    registerTest<DataEstimator2DUnitTest>("quadratic_steep_2D", [](const float_s x) -> float_s {
        return 1.17f * x * x + 1.6f * x + 17.4f;
    }, EstimationMode::LINEAR, 0.0f, 1'000, -10.0f, 10.0f, 1e-04);
    registerTest<DataEstimator2DUnitTest>("quadratic_negative_2D", [](const float_s x) -> float_s {
        return -0.02f * x * x + 7.6f * x - 1.5f;
    }, EstimationMode::LINEAR, 0.0f, 1'000, -50.0f, 50.0f, 1e-04);
    registerTest<DataEstimator2DUnitTest>("quadratic_loss_2D", [](const float_s x) -> float_s {
        return -0.02f * x * x + 7.6f * x - 1.5f;
    }, EstimationMode::LINEAR, 1e-04f, 1'000, -50.0f, 50.0f, 1e+00);
    registerTest<DataEstimator2DUnitTest>("cubic_steep_2D", [](const float_s x) -> float_s {
        return 1.2f * x * x * x + 6.9f * x * x + 1.1f * x + 3.25f;
    }, EstimationMode::LINEAR, 0.0f, 1'000, -20.0f, 20.0f, 1e-02);
    registerTest<DataEstimator2DUnitTest>("cubic_negative_2D", [](const float_s x) -> float_s {
        return -0.025f * x * x * x - 0.5f * x * x + 7.1f * x - 1.5f;
    }, EstimationMode::LINEAR, 0.0f, 1'000, -5.0f, 5.0f, 1e-03);
    registerTest<DataEstimator2DUnitTest>("cubic_loss_2D", [](const float_s x) -> float_s {
        return -0.025f * x * x * x - 0.5f * x * x + 7.1f * x - 1.5f;
    }, EstimationMode::LINEAR, 1e-04f, 1'000, -5.0f, 5.0f, 1e-01);
    registerTest<DataEstimator2DUnitTest>("sin_2D", [](const float_s x) -> float_s {
        return std::sin(x);
    }, EstimationMode::LINEAR, 0.0f, 1'000, -10.0f, 10.0f, 1e-04);
    registerTest<DataEstimator2DUnitTest>("sin_loss_2D", [](const float_s x) -> float_s {
        return std::sin(x);
    }, EstimationMode::LINEAR, 1e-02f, 1'000, -10.0f, 10.0f, 1e-01);
    registerTest<DataEstimator2DUnitTest>("tetration_1_2D", [](const float_s x) -> float_s {
        return std::pow(x, x);
    }, EstimationMode::LINEAR, 0.0f, 1'000, 0.0f, 2.0f, 1e-05);
    registerTest<DataEstimator2DUnitTest>("tetration_1_loss_2D", [](const float_s x) -> float_s {
        return std::pow(x, x);
    }, EstimationMode::LINEAR, 1e-03f, 1'000, 0.0f, 2.0f, 1e-01);
    registerTest<DataEstimator2DUnitTest>("fuzz_2D", [](const float_s x) -> float_s {
