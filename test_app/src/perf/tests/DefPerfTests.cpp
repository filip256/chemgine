...
DefPerfSetup::DefPerfSetup(std::string&& inputPath, std::string&& outputPath, const bool prettify) noexcept :
...
DefPerfTests::DefPerfTests(std::string&& name, const std::regex& filter, const std::string& inputPath) noexcept :
