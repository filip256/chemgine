...
public:
    ...
    inline constexpr StorageType asMilli() const noexcept;
    inline constexpr StorageType asMicro() const noexcept;

    template <Unit OUnitT, Unit FactT1>
    inline constexpr Amount<OUnitT> to(const Amount<FactT1>) const noexcept = delete;
    ...
    inline constexpr bool isUnknown() const noexcept;
...
template <Unit UnitT>
const Amount<UnitT> Amount<UnitT>::Unknown =
    std::numeric_limits<StorageType>::min() - std::numeric_limits<StorageType>::epsilon();
template <Unit UnitT>
...
template <Unit UnitT>
constexpr Amount<>::StorageType Amount<UnitT>::asStd() const noexcept
{
    return value;
}

template <Unit UnitT>
constexpr Amount<>::StorageType Amount<UnitT>::asKilo() const noexcept
{
    return static_cast<StorageType>(value / 1000.0);
}

template <>
constexpr Amount<>::StorageType Amount<Unit::CUBIC_METER>::asKilo() const noexcept
{
    return static_cast<StorageType>(value / 1000000000.0);
}

template <Unit UnitT>
constexpr Amount<>::StorageType Amount<UnitT>::asMilli() const noexcept
{
    return static_cast<StorageType>(value * 1000.0);
}

template <>
constexpr Amount<>::StorageType Amount<Unit::CUBIC_METER>::asMilli() const noexcept
{
    return static_cast<StorageType>(value * 1000000000.0);
}

template <Unit UnitT>
constexpr Amount<>::StorageType Amount<UnitT>::asMicro() const noexcept
{
    return static_cast<StorageType>(value * 1000000.0);
}

template <>
constexpr Amount<>::StorageType Amount<Unit::CUBIC_METER>::asMicro() const noexcept
{
    return static_cast<StorageType>(value * 1000000000000000000.0);
}

template <Unit UnitT>
constexpr Unit Amount<UnitT>::unit() const noexcept
{
    return UnitT;
}

template <>
inline std::string Amount<Unit::NONE>::unitSymbol() noexcept
{
    return "1";
}

template <>
inline std::string Amount<Unit::ANY>::unitSymbol() noexcept
{
    return "*";
}

template <>
inline std::string Amount<Unit::GRAM>::unitSymbol() noexcept
{
    return "g";
}

template <>
inline std::string Amount<Unit::LITER>::unitSymbol() noexcept
{
    return "L";
}

template <>
inline std::string Amount<Unit::CUBIC_METER>::unitSymbol() noexcept
{
    return "m3";
}

template <>
inline std::string Amount<Unit::DROP>::unitSymbol() noexcept
{
    return "drops";
}

template <>
inline std::string Amount<Unit::MOLE>::unitSymbol() noexcept
{
    return "mol";
}

template <>
inline std::string Amount<Unit::SECOND>::unitSymbol() noexcept
{
    return "s";
}

template <>
inline std::string Amount<Unit::CELSIUS>::unitSymbol() noexcept
{
    return "C";
}

template <>
inline std::string Amount<Unit::KELVIN>::unitSymbol() noexcept
{
    return "K";
}

template <>
inline std::string Amount<Unit::FAHRENHEIT>::unitSymbol() noexcept
{
    return "F";
}

template <>
inline std::string Amount<Unit::TORR>::unitSymbol() noexcept
{
    return "torr";
}

template <>
inline std::string Amount<Unit::PASCAL>::unitSymbol() noexcept
{
    return "Pa";
}

template <>
inline std::string Amount<Unit::ATMOSPHERE>::unitSymbol() noexcept
{
    return "atm";
}

template <>
inline std::string Amount<Unit::JOULE>::unitSymbol() noexcept
{
    return "J";
}

template <>
inline std::string Amount<Unit::WATT>::unitSymbol() noexcept
{
    return "W";
}

template <>
inline std::string Amount<Unit::METER>::unitSymbol() noexcept
{
    return "m";
}

template <>
inline std::string Amount<Unit::DEGREE>::unitSymbol() noexcept
{
    return "o";
}

template <>
inline std::string Amount<Unit::RADIAN>::unitSymbol() noexcept
{
    return "rad";
}

template <>
inline std::string Amount<Unit::PER_SECOND>::unitSymbol() noexcept
{
    return "/" + Amount<Unit::SECOND>::unitSymbol();
}

template <>
inline std::string Amount<Unit::PER_METER>::unitSymbol() noexcept
{
    return "/" + Amount<Unit::METER>::unitSymbol();
}

template <>
inline std::string Amount<Unit::MOLE_RATIO>::unitSymbol() noexcept
{
    return Amount<Unit::MOLE>::unitSymbol() + "/" + Amount<Unit::MOLE>::unitSymbol();
}

template <>
inline std::string Amount<Unit::MOLE_PERCENT>::unitSymbol() noexcept
{
    return Amount<Unit::MOLE>::unitSymbol() + "%";
}

template <>
inline std::string Amount<Unit::MOLE_PER_SECOND>::unitSymbol() noexcept
{
    return Amount<Unit::MOLE>::unitSymbol() + "/" + Amount<Unit::SECOND>::unitSymbol();
}

template <>
inline std::string Amount<Unit::GRAM_PER_MOLE>::unitSymbol() noexcept
{
    return Amount<Unit::GRAM>::unitSymbol() + "/" + Amount<Unit::MOLE>::unitSymbol();
}

template <>
inline std::string Amount<Unit::GRAM_PER_MILLILITER>::unitSymbol() noexcept
{
    return Amount<Unit::GRAM>::unitSymbol() + "/m" + Amount<Unit::LITER>::unitSymbol();
}

template <>
inline std::string Amount<Unit::JOULE_PER_MOLE>::unitSymbol() noexcept
{
    return Amount<Unit::JOULE>::unitSymbol() + "/" + Amount<Unit::MOLE>::unitSymbol();
}

template <>
inline std::string Amount<Unit::JOULE_PER_CELSIUS>::unitSymbol() noexcept
{
    return Amount<Unit::JOULE>::unitSymbol() + "/" + Amount<Unit::CELSIUS>::unitSymbol();
}

template <>
inline std::string Amount<Unit::JOULE_PER_MOLE_CELSIUS>::unitSymbol() noexcept
{
    return Amount<Unit::JOULE>::unitSymbol() +
           "/(" +
           Amount<Unit::MOLE>::unitSymbol() +
           "*" +
           Amount<Unit::CELSIUS>::unitSymbol() +
           ")";
}

template <>
inline std::string Amount<Unit::TORR_MOLE_RATIO>::unitSymbol() noexcept
{
...
template <>
inline std::string Amount<Unit::NONE>::unitName() noexcept
{
    return "";
}

template <>
inline std::string Amount<Unit::ANY>::unitName() noexcept
{
    return "any unit";
}

template <>
inline std::string Amount<Unit::GRAM>::unitName() noexcept
{
    return "gram";
}

template <>
inline std::string Amount<Unit::LITER>::unitName() noexcept
{
    return "liter";
}

template <>
inline std::string Amount<Unit::CUBIC_METER>::unitName() noexcept
{
    return "cubic meter";
}

template <>
inline std::string Amount<Unit::DROP>::unitName() noexcept
{
    return "drops";
}

template <>
inline std::string Amount<Unit::MOLE>::unitName() noexcept
{
    return "mole";
}

template <>
inline std::string Amount<Unit::SECOND>::unitName() noexcept
{
    return "second";
}

template <>
inline std::string Amount<Unit::CELSIUS>::unitName() noexcept
{
    return "celsius";
}

template <>
inline std::string Amount<Unit::KELVIN>::unitName() noexcept
{
    return "kelvin";
}

template <>
inline std::string Amount<Unit::FAHRENHEIT>::unitName() noexcept
{
    return "fahrenheit";
}

template <>
inline std::string Amount<Unit::TORR>::unitName() noexcept
{
    return "torr";
}

template <>
inline std::string Amount<Unit::PASCAL>::unitName() noexcept
{
    return "pascal";
}

template <>
inline std::string Amount<Unit::ATMOSPHERE>::unitName() noexcept
{
    return "atmosphere";
}

template <>
inline std::string Amount<Unit::JOULE>::unitName() noexcept
{
    return "joule";
}

template <>
inline std::string Amount<Unit::WATT>::unitName() noexcept
{
    return "watt";
}

template <>
inline std::string Amount<Unit::METER>::unitName() noexcept
{
    return "meter";
}

template <>
inline std::string Amount<Unit::DEGREE>::unitName() noexcept
{
    return "degree";
}

template <>
inline std::string Amount<Unit::RADIAN>::unitName() noexcept
{
    return "radian";
}

template <>
inline std::string Amount<Unit::PER_SECOND>::unitName() noexcept
{
    return "/" + Amount<Unit::SECOND>::unitName();
}

template <>
inline std::string Amount<Unit::PER_METER>::unitName() noexcept
{
    return "/" + Amount<Unit::METER>::unitName();
}

template <>
inline std::string Amount<Unit::MOLE_RATIO>::unitName() noexcept
{
    return Amount<Unit::MOLE>::unitName() + " / " + Amount<Unit::MOLE>::unitName();
}

template <>
inline std::string Amount<Unit::MOLE_PERCENT>::unitName() noexcept
{
    return Amount<Unit::MOLE>::unitName() + " %";
}

template <>
inline std::string Amount<Unit::MOLE_PER_SECOND>::unitName() noexcept
{
    return Amount<Unit::MOLE>::unitName() + " / " + Amount<Unit::SECOND>::unitName();
}

template <>
inline std::string Amount<Unit::GRAM_PER_MOLE>::unitName() noexcept
{
    return Amount<Unit::GRAM>::unitName() + " / " + Amount<Unit::MOLE>::unitName();
}

template <>
inline std::string Amount<Unit::GRAM_PER_MILLILITER>::unitName() noexcept
{
    return Amount<Unit::GRAM>::unitName() + " / milli" + Amount<Unit::LITER>::unitName();
}

template <>
inline std::string Amount<Unit::JOULE_PER_MOLE>::unitName() noexcept
{
    return Amount<Unit::JOULE>::unitName() + " / " + Amount<Unit::MOLE>::unitName();
}

template <>
inline std::string Amount<Unit::JOULE_PER_CELSIUS>::unitName() noexcept
{
    return Amount<Unit::JOULE>::unitName() + " / " + Amount<Unit::CELSIUS>::unitName();
}

template <>
inline std::string Amount<Unit::JOULE_PER_MOLE_CELSIUS>::unitName() noexcept
{
    return Amount<Unit::JOULE>::unitName() +
           " / (" +
           Amount<Unit::MOLE>::unitName() +
           " + " +
           Amount<Unit::CELSIUS>::unitName() +
           ")";
}

template <>
inline std::string Amount<Unit::TORR_MOLE_RATIO>::unitName() noexcept
{
...
template <>
template <>
constexpr Amount<Unit::JOULE_PER_MOLE>
Amount<Unit::JOULE_PER_MOLE_CELSIUS>::to(const Amount<Unit::CELSIUS> temperature) const noexcept
{
    return value * temperature.asStd();
}
...
template <>
template <>
constexpr Amount<Unit::JOULE_PER_MOLE_CELSIUS>
Amount<Unit::JOULE_PER_MOLE>::to(const Amount<Unit::CELSIUS> temperature) const noexcept
{
    return value / temperature.asStd();
}
...
template <>
template <>
constexpr Amount<Unit::JOULE_PER_CELSIUS>
Amount<Unit::JOULE_PER_MOLE_CELSIUS>::to(const Amount<Unit::MOLE> moles) const noexcept
{
    return value * moles.asStd();
}
...
template <>
constexpr Amount<Unit::JOULE_PER_MOLE_CELSIUS>
Amount<Unit::JOULE_PER_CELSIUS>::to(const Amount<Unit::MOLE> moles) const noexcept
{
    return value / moles.asStd();
}
...
{
public:
    static std::string print(const Amount<U> object) { return def::print(object.asStd()); }
