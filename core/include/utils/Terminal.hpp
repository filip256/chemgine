...
constexpr OS::ColorType OS::brighten(const ColorType color) { return color | 0x0008 | 0x0080; }

constexpr OS::ColorType OS::darken(const ColorType color) { return color & ~0x0008 & ~0x0080; }
