...
public:
    ...
    const EstimatorRef<Unit::JOULE_PER_MOLE, Unit::CELSIUS, Unit::TORR>
        vaporizationLatentHeatEstimator;
    const EstimatorRef<Unit::JOULE_PER_MOLE, Unit::CELSIUS, Unit::TORR>
        sublimationLatentHeatEstimator;
    ...
    MoleculeData(
        ...
        EstimatorRef<Unit::JOULE_PER_MOLE, Unit::CELSIUS, Unit::TORR>&&
            vaporizationLatentHeatEstimator,
        EstimatorRef<Unit::JOULE_PER_MOLE, Unit::CELSIUS, Unit::TORR>&&
                                                             sublimationLatentHeatEstimator,
