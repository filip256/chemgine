...
void Lab::add(LabwareSystem&& system) { systems.emplace_back(std::move(system)); }
...
const LabwareSystem& Lab::getSystem(const size_t idx) const { return systems[idx]; }

LabwareSystem& Lab::getSystem(const size_t idx) { return systems[idx]; }

const Atmosphere& Lab::getAtmosphere() const { return *atmosphere; }

Atmosphere& Lab::getAtmosphere() { return *atmosphere; }
...
Lab::LabSystemsConstIterator Lab::getSystemsBegin() const { return systems.cbegin(); }

Lab::LabSystemsConstIterator Lab::getSystemsEnd() const { return systems.cend(); }

Lab::LabSystemsIterator Lab::getSystemsBegin() { return systems.begin(); }

Lab::LabSystemsIterator Lab::getSystemsEnd() { return systems.end(); }
