...
Amount<Unit::LITER> MultiLayerMixture::getMaxVolume() const { return maxVolume; }

const Layer& MultiLayerMixture::getLayer(const LayerType layer) const { return layers.at(layer); }
...
Ref<ContainerBase> MultiLayerMixture::getOverflowTarget() const { return overflowTarget; }
...
Amount<Unit::TORR> MultiLayerMixture::getPressure() const { return pressure; }

Amount<Unit::MOLE> MultiLayerMixture::getTotalMoles() const { return totalMoles; }

Amount<Unit::GRAM> MultiLayerMixture::getTotalMass() const { return totalMass; }
...
MultiLayerMixture MultiLayerMixture::makeCopy() const { return MultiLayerMixture(*this); }
