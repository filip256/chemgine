...
std::string ColoredString::toString() const
{
    ...
    std::ranges::transform(str, std::back_inserter(temp), [](const auto c) { return c.chr; });

    return temp;
}

bool ColoredString::empty() const { return str.empty(); }

size_t ColoredString::size() const { return str.size(); }

void ColoredString::clear() { str.clear(); }
...
ColoredString::Iterator ColoredString::begin() { return str.begin(); }

ColoredString::Iterator ColoredString::end() { return str.end(); }

ColoredString::ConstIterator ColoredString::begin() const { return str.begin(); }

ColoredString::ConstIterator ColoredString::end() const { return str.end(); }

ColoredString::ConstIterator ColoredString::cbegin() const { return str.cbegin(); }

ColoredString::ConstIterator ColoredString::cend() const { return str.cend(); }

ColoredString::ReverseIterator ColoredString::rbegin() { return str.rbegin(); }

ColoredString::ReverseIterator ColoredString::rend() { return str.rend(); }

ColoredString::ConstReverseIterator ColoredString::rbegin() const { return str.rbegin(); }

ColoredString::ConstReverseIterator ColoredString::rend() const { return str.rend(); }

ColoredString::ConstReverseIterator ColoredString::crbegin() const { return str.crbegin(); }

ColoredString::ConstReverseIterator ColoredString::crend() const { return str.crend(); }

ColoredChar ColoredString::front() const { return str.front(); }

ColoredChar& ColoredString::front() { return str.front(); }

ColoredChar ColoredString::back() const { return str.back(); }

ColoredChar& ColoredString::back() { return str.back(); }

void ColoredString::push_back(const ColoredChar coloredChr) { str.push_back(coloredChr); }
...
ColoredChar ColoredString::operator[](const size_t idx) const { return str[idx]; }

ColoredChar& ColoredString::operator[](const size_t idx) { return str[idx]; }
...
ColoredString& ColoredString::operator<<(const ColoredChar chr) { return operator+=(chr); }
