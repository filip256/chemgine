...
namespace ASCII
{
    ...
    private:
        ...
        static std::optional<std::pair<Position, Direction>> inferEdgePosition(
        ...
        bool isAmbiguousBondPlacement(const Position position, const Direction direction, const BondType bondType,
        ...
        std::vector<PositionLine> generateOptimalCycleLayout(
            ...
            const c_size firstCycleIdx, const c_size secondCycleIdx, const c_size lastCycleIdx,
            const bool noConstraints, const Direction enteringDirection) const;
        std::vector<PositionLine> generateOneShotCycleLayout(
            const std::vector<const BondedAtomBase*>& cycle,
            const c_size firstCycleIdx, const c_size secondCycleIdx, const Direction enteringDirection) const;
    ...
    public:
        static std::vector<std::pair<ASCII::Direction, Position>> getPossibleNextDirections(
